...
# model.numericalSolution = numericalSolution(model, y0 = c(1, 1), 
...
# model.numericalSolution = numericalSolution(model, y0 = c(1, 2), 
#                                             tlim = c(0, 20), type = "one",
#                                             parameters = pars, 
#                                             state.names = c("s1", "s2"),
#                                             col = c("green", "orange"), 
...
# 
# 
# model.numericalSolution = numericalSolution(model, y0 = c(2, 1), 
#                                             tlim = c(0, 20), type = "one",
#                                             parameters = pars,
#                                             state.names = c("s1", "s2"),
#                                             col = c("green", "orange"), 
